  ...
  return (
    <div className="space-y-12">
      ...
      <section>
        ...
        <h2 className="section-title">어떤 데이터로 배우나</h2>
      ...
      <section>
        ...
        <h2 className="section-title">합성 자취방 데이터로 검증했습니다 (PoC)</h2>
        <p className="section-sub">
          실제 데이터를 아직 충분히 모으지 못해, 1인가구 전력을 비슷하게 만든 합성 데이터로 오토인코더를 학습시키고

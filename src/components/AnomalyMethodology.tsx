...
export default function AnomalyMethodology() {
  return (
    <div className="space-y-8">
      <p className="rounded-lg bg-amber-soft p-4 text-sm text-slate-600">오토인코더 적용 방법을 설명하는 참고 자료입니다. 아래 그래프는 저장된 이미지이며, 성능 수치는 기존 화면의 고정 참고값으로 실험 코드·가중치를 확인하지 못했습니다. 선택한 가정의 실측 진단 결과가 아닙니다.</p>
      {/* 헤더 */}
      <section className="card overflow-hidden">
        <div className="p-8 md:p-10">
          ...
          <h3 className="mt-4 text-3xl font-extrabold leading-tight tracking-tight md:text-4xl">
            오토인코더 기반 <span className="text-teal">이상탐지 방법</span>
          </h3>
      ...
      <section>
        ...
        <h2 className="section-title">학습에 사용할 데이터</h2>
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          <div className="card p-6">
            ...
            <p className="mt-2 text-sm text-slate-500">
              가전기기 전력 사용량 데이터로 &lsquo;정상 생활 패턴&rsquo;을 폭넓게 학습하는 것을 목표로 합니다.
              train / holdout으로 나누어 <b>처음 보는 가구</b>에서도 재현되는지 검증할 계획입니다.
            </p>
          </div>
          <div className="card p-6">
            <div className="flex items-center gap-2">
      ...
      <section>
        ...
        <h2 className="section-title">오토인코더는 이렇게 작동합니다</h2>
        <p className="section-sub">평소 패턴을 &lsquo;압축했다 복원&rsquo;하도록 학습합니다. 이상이 오면 복원이 어긋납니다.</p>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-[1fr_1.1fr]">
          <div className="card p-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              모델을 평소 모습을 잘 복원하도록 학습하는 방식입니다. 그러다 TV·조명이 종일 켜져 있거나 요리·활동이 갑자기 끊기면,
              평소와 달라 <b>복원이 크게 어긋납니다</b>. 그 어긋난 정도가 곧 이상 신호가 됩니다.
            </p>
          </div>
          <div className="card self-center p-3">
            <Image width={1430} height={468} unoptimized src={`${BP}/anomaly/recon_compare.png`} alt="정상 vs 이상 복원 비교" className="w-full rounded-lg" />
      ...
      <section>
        ...
        <h2 className="section-title">응급상황을 세 가지로 나눕니다</h2>
        <p className="section-sub">정상 · 응급 · 예외로 나누어, 진짜 위험만 걸러냅니다.</p>
      ...
      <section>
        ...
        <h2 className="section-title">기존 합성 데이터 PoC 참고 자료</h2>
        <p className="section-sub">
          기존 페이지에 합성 데이터 실험 결과로 소개된 자료입니다. 현재 웹에서 모델을 실행하거나 아래 성능을 재검증하지 않으며, 가정별 실측 성능을 의미하지 않습니다.
        </p>
        ...
        <div className="mt-4 card p-4">
          <div className="px-2 pt-1 text-sm font-bold">재구성 오차가 곧 이상 점수입니다. 정상은 낮고, 이상은 임계값을 넘습니다.</div>
          <Image width={1430} height={442} unoptimized src={`${BP}/anomaly/error_timeline.png`} alt="재구성 오차 타임라인" className="mt-2 w-full rounded-lg" />
        </div>
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="card p-4">
            <div className="px-2 pt-1 text-sm font-bold">오차 분포로 보면 정상과 이상이 갈립니다.</div>
            <Image width={910} height={416} unoptimized src={`${BP}/anomaly/error_dist.png`} alt="오차 분포" className="mt-2 w-full rounded-lg" />
          </div>
          <div className="card p-5">
            <div className="font-bold">읽는 법</div>
            <ul className="mt-2 space-y-1.5 text-sm text-slate-500">
              <li>· 기존 자료의 활동정지 시나리오: <b>첫날 탐지</b>로 표기</li>
              <li>· 기존 자료의 오탐률 표기: 10%</li>
              <li>· &lsquo;정상&rsquo; 패턴만 학습하는 방식에 대한 예시</li>
